...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnMinSalaryInDept30()
    {
        ...
        decimal? minSalary = emps.Where(e => e.Sal == 30).Min(e=>e.Sal);
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            .Join(depts, 
                emp => emp.DeptNo,
                dept => dept.DeptNo,
                (emp, dept) => new { emp.EName, emp.Sal, dept.DName })
            .Join(grades, 
                empDept => empDept.Sal, 
                grade => grade.Losal, 
                (empDept, grade) => new { empDept.EName, empDept.DName, Grade = grade.Grade })
            .ToList();
