...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldReturnDept30EmpsOrderedBySalaryDesc()
    {
        ...
        result.Sort((a, b) => b.Sal.CompareTo(a.Sal));
    ...
    public void ShouldReturnEmployeesFromChicago()
    {
        ...
        List<Emp> result =
            (from emp in emps from dept in depts where emp.DeptNo == dept.DeptNo && dept.Loc == "CHICAGO" select emp)
            .ToList();
